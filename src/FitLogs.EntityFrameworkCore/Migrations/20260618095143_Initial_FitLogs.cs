...
{
    /// <inheritdoc />
    public partial class Initial_FitLogs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaloriesPer100g = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ProteinPer100g = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    CarbPer100g = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    FatPer100g = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    ServingSize = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppFoodProducts", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AppMuscleGroups",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMuscleGroups", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppWorkoutSessions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Calories = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Protein = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    Carb = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    Fat = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppFoodLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppFoodLogs_AppFoodProducts_FoodProductId",
                        column: x => x.FoodProductId,
                        principalTable: "AppFoodProducts",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FormTips = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    CommonMistakes = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppExercises_AppEquipment_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "AppEquipment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppExercises_AppMuscleGroups_PrimaryMuscleGroupId",
                        column: x => x.PrimaryMuscleGroupId,
                        principalTable: "AppMuscleGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "AppWorkoutPlanExercises",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    DefaultWeightKg = table.Column<float>(type: "real", nullable: true),
                    RestSeconds = table.Column<int>(type: "integer", nullable: true),
                    Note = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppWorkoutPlanExercises", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppWorkoutPlanExercises_AppWorkoutPlans_WorkoutPlanId",
            ...
            migrationBuilder.CreateTable(
                name: "AppWorkoutSessionExercises",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    WorkoutSessionId = table.Column<Guid>(type: "uuid", nullable: false),
                    ExerciseId = table.Column<Guid>(type: "uuid", nullable: false),
                    WorkoutPlanExerciseId = table.Column<Guid>(type: "uuid", nullable: true),
                    OrderIndex = table.Column<int>(type: "integer", nullable: false),
                    TargetSets = table.Column<int>(type: "integer", nullable: false),
                    TargetReps = table.Column<int>(type: "integer", nullable: false),
                    TargetWeightKg = table.Column<float>(type: "real", nullable: true),
                    RestSeconds = table.Column<int>(type: "integer", nullable: true),
                    Note = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppWorkoutSessionExercises", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppWorkoutSessionExercises_AppWorkoutSessions_WorkoutSessio~",
                        column: x => x.WorkoutSessionId,
                        principalTable: "AppWorkoutSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppExerciseSets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppExerciseSets_AppWorkoutSessionExercises_WorkoutSessionEx~",
                        column: x => x.WorkoutSessionExerciseId,
                        principalTable: "AppWorkoutSessionExercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppEquipment_DisplayOrder",
                table: "AppEquipment",
                column: "DisplayOrder");

            migrationBuilder.CreateIndex(
                name: "IX_AppEquipment_IsActive",
                table: "AppEquipment",
                column: "IsActive");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppExercises_Difficulty",
                table: "AppExercises",
                column: "Difficulty");

            migrationBuilder.CreateIndex(
                name: "IX_AppExercises_EquipmentId",
                table: "AppExercises",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AppExercises_IsActive",
                table: "AppExercises",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_AppExercises_Name_EquipmentId",
                table: "AppExercises",
                columns: new[] { "Name", "EquipmentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppExercises_PrimaryMuscleGroupId",
                table: "AppExercises",
                column: "PrimaryMuscleGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_AppExercises_Slug",
                table: "AppExercises",
                column: "Slug",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppExerciseSets_WorkoutSessionExerciseId",
                table: "AppExerciseSets",
                column: "WorkoutSessionExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_AppExerciseSets_WorkoutSessionExerciseId_SetNumber",
                table: "AppExerciseSets",
                columns: new[] { "WorkoutSessionExerciseId", "SetNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppFoodLogs_FoodProductId",
                table: "AppFoodLogs",
                column: "FoodProductId");

            migrationBuilder.CreateIndex(
                name: "IX_AppFoodLogs_MealType",
                table: "AppFoodLogs",
                column: "MealType");

            migrationBuilder.CreateIndex(
                name: "IX_AppFoodLogs_UserId_LoggedAt",
                table: "AppFoodLogs",
                columns: new[] { "UserId", "LoggedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_AppFoodProducts_Barcode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppFoodProducts_IsActive",
                table: "AppFoodProducts",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_AppFoodProducts_IsVerified",
                table: "AppFoodProducts",
                column: "IsVerified");

            migrationBuilder.CreateIndex(
                name: "IX_AppFoodProducts_Name",
                table: "AppFoodProducts",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_AppFoodProducts_Source",
                table: "AppFoodProducts",
                column: "Source");

            migrationBuilder.CreateIndex(
                name: "IX_AppMuscleGroups_Code",
                table: "AppMuscleGroups",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppMuscleGroups_DisplayOrder",
                table: "AppMuscleGroups",
                column: "DisplayOrder");

            migrationBuilder.CreateIndex(
                name: "IX_AppMuscleGroups_IsActive",
                table: "AppMuscleGroups",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_AppMuscleGroups_Name",
                table: "AppMuscleGroups",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppWorkoutPlanExercises_ExerciseId",
                table: "AppWorkoutPlanExercises",
                column: "ExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_AppWorkoutPlanExercises_WorkoutPlanId",
                table: "AppWorkoutPlanExercises",
                column: "WorkoutPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_AppWorkoutPlanExercises_WorkoutPlanId_ExerciseId",
                table: "AppWorkoutPlanExercises",
                columns: new[] { "WorkoutPlanId", "ExerciseId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppWorkoutPlanExercises_WorkoutPlanId_OrderIndex",
                table: "AppWorkoutPlanExercises",
                columns: new[] { "WorkoutPlanId", "OrderIndex" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppWorkoutPlans_UserId",
                table: "AppWorkoutPlans",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppWorkoutSessionExercises_ExerciseId",
                table: "AppWorkoutSessionExercises",
                column: "ExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_AppWorkoutSessionExercises_WorkoutSessionId",
                table: "AppWorkoutSessionExercises",
                column: "WorkoutSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_AppWorkoutSessionExercises_WorkoutSessionId_ExerciseId",
                table: "AppWorkoutSessionExercises",
                columns: new[] { "WorkoutSessionId", "ExerciseId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppWorkoutSessionExercises_WorkoutSessionId_OrderIndex",
                table: "AppWorkoutSessionExercises",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppWorkoutSessions_WorkoutPlanId",
                table: "AppWorkoutSessions",
                column: "WorkoutPlanId");
