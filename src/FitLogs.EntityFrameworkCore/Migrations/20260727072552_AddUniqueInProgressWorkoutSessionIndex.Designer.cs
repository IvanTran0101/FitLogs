...
namespace FitLogs.Migrations
{
    ...
    [Migration("20260727072552_AddUniqueInProgressWorkoutSessionIndex")]
    partial class AddUniqueInProgressWorkoutSessionIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitLogs.Exercises.Equipment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FitLogs.Exercises.Exercise", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Name", "EquipmentId")
                        .IsUnique();

                    b.ToTable("AppExercises", (string)null);
                });

            modelBuilder.Entity("FitLogs.Exercises.MuscleGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppMuscleGroups", (string)null);
                });

            modelBuilder.Entity("FitLogs.Foods.FoodLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppFoodLogs", (string)null);
                });

            modelBuilder.Entity("FitLogs.Foods.FoodProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppFoodProducts", (string)null);
                });

            modelBuilder.Entity("FitLogs.UserProfiles.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FitLogs.Workouts.ExerciseSet", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppExerciseSets", (string)null);
                });

            modelBuilder.Entity("FitLogs.Workouts.WorkoutPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FitLogs.Workouts.WorkoutPlanExercise", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<float?>("DefaultWeightKg")
                        .HasColumnType("real");
                    ...
                    b.HasIndex("WorkoutPlanId", "ExerciseId")
                        .IsUnique();

                    b.HasIndex("WorkoutPlanId", "OrderIndex")
                        .IsUnique();

                    b.ToTable("AppWorkoutPlanExercises", (string)null);
                });
            ...
            modelBuilder.Entity("FitLogs.Workouts.WorkoutSession", b =>
                {
                    ...
                    b.ToTable("AppWorkoutSessions", (string)null);
                });
            ...
            modelBuilder.Entity("FitLogs.Workouts.WorkoutSessionExercise", b =>
                {
                    ...
                    b.Property<Guid?>("WorkoutPlanExerciseId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppWorkoutSessionExercises", (string)null);
                });
            ...
            modelBuilder.Entity("FitLogs.Exercises.Exercise", b =>
                {
                    b.HasOne("FitLogs.Exercises.Equipment", null)
                        .WithMany()
                        .HasForeignKey("EquipmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FitLogs.Exercises.MuscleGroup", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FitLogs.Foods.FoodLog", b =>
                {
                    b.HasOne("FitLogs.Foods.FoodProduct", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FitLogs.Workouts.ExerciseSet", b =>
                {
                    b.HasOne("FitLogs.Workouts.WorkoutSessionExercise", null)
                        .WithMany("Sets")
            ...
            modelBuilder.Entity("FitLogs.Workouts.WorkoutSessionExercise", b =>
                {
                    b.HasOne("FitLogs.Workouts.WorkoutSession", null)
                        .WithMany("Exercises")
