...
public class FitLogsDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        FitLogsGlobalFeatureConfigurator.Configure();
        FitLogsModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<FitLogsDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<FitLogsResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/FitLogs");

            options.DefaultResourceType = typeof(FitLogsResource);
        ...
        {
            options.MapCodeNamespace("FitLogs", typeof(FitLogsResource));
        });
    }
}
